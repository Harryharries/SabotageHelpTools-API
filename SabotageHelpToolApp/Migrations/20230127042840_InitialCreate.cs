    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CharacterTurnActions", x => new { x.CharacterId, x.TurnActionId });
                    table.ForeignKey(
                        name: "FK_CharacterTurnActions_Characters_CharacterId",
                        column: x => x.CharacterId,
                        principalTable: "Characters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CharacterTurnActions_TurnActions_TurnActionId",
                        column: x => x.TurnActionId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    reviewersId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CharacterTurnActions_TurnActionId",
                table: "CharacterTurnActions",
                column: "TurnActionId");
